...
export type BevoPattern = 'none' | 'heart' | 'scales' | 'stars' | 'dots' | 'diamonds';

export const BEVO_PATTERNS = ['none', 'heart', 'scales', 'stars', 'dots', 'diamonds'] as const;

// Head accessories: a vector layer positioned on the head. Each id maps to
// artwork in BevoAvatar. 'none' is bare-headed.
export type BevoHat = 'none' | 'cap' | 'headphones' | 'topHat';

export const BEVO_HATS = ['none', 'cap', 'headphones', 'topHat'] as const;
